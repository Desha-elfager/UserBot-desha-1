...
async def song(client, message: Message):
    ...
    pablo = await client.send_message(
        message.chat.id, f"**🔎 أغنية البحث 🌚** `{urlissed}`"
    )
    ...
    capy = f"""
**🎙إسم الأغنية:** {thum}
**🗂️بتوصية من:** {message.from_user.mention}
"""
...
async def vsong(client, message: Message):
    ...
    pablo = await client.send_message(
        message.chat.id, f"**🔎 البحث عن الفيديو 🎞..** `{urlissed}`"
    )
    if not urlissed:
    ...
    capy = f"""
**📽 فيديو :** {thum}
**🔎 بتوصية من:** {message.from_user.mention}
"""
